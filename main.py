...
def handle_text(message):
    ...
    if message.from_user.id == 6179535998:
        font = ImageFont.truetype('MDWRohr/MDWRohr-Regular.ttf', size=50)
    elif message.from_user.id == 65784765:
        font = ImageFont.truetype('AMSoehartono/Amsoehartono-Regular.ttf', size=50)
    else:
        print(message.from_user.id)
    ...
    wrapped_text = '\n'.join(textwrap.wrap(text_content, width=18))
